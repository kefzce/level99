...
Результат має бути представлений у вигляді коду, виклденого у репозиторій.
Readme має містити базовий опис про систему і як її запустити.
Запуск оточення має бути реалізаваний через docker-compose
Система має містити 4 ендпойти, які відповідають за створення/редагуавання/читання та видаленні відповідно
